    ...
    try {
        ...
        upload.single("file")(req, res, async function (err) {
            ...
            try {
                ...
                const jsonData = XLSX.utils.sheet_to_json(worksheet, {raw: false, blankrows: false});
                ...
                const transactions = jsonData.map((data) => {
                    ...
                    if(title === undefined || amount === undefined || type === undefined || date === undefined || description === undefined) {
                        return res.status(422).json({message: "Invalid Data on row: " + counterForRows});
                    }
